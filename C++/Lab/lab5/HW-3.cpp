...
class InsuredRegisteredPost : public RegisteredPost
{
    ...
    public:
    InsuredRegisteredPost() : RegisteredPost(), AmtInsured(20.0) {} 
    InsuredRegisteredPost(float amt) : RegisteredPost(), AmtInsured(amt) {}
    ...
    void Print() override
    {
        ...
        cout << "Total Combined Cost with Insurance: $" << TotalCost() << endl;
    }
